...
/*
SetOnExists - adds "on_exist" parameter to the request - Optional parameter to determine the API behavior
...
Can be used in the following methods:
  - FileApi.UploadFile
*/
func (p *Parameters) SetOnExists(onExists string) *Parameters {
